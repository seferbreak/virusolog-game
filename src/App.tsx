    ...
    <>
      ...
      <div id="ui-scaler">
        ...
        <div id="start-screen">
            ...
            <div id="btn-start" className="start-btn disabled">ИГРАТЬ</div>
            <p id="controls-desc" style={{ fontSize: '6px', marginTop: '20px', color: '#666' }}>Подождите, идет загрузка 3D моделей (20 МБ)</p>
        </div>
      </div>
    </>
  );
